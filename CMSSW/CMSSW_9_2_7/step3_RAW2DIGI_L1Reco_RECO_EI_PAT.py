...
# with command line options: step3 --conditions 92X_upgrade2017_realistic_v7 -n 10 --eventcontent MINIAODSIM --runUnscheduled -s RAW2DIGI,L1Reco,RECO,EI,PAT --datatier MINIAODSIM --filein file://step2.root --fileout step3miniaod.root --nThreads 4 --no_exec
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('step3miniaod.root'),
